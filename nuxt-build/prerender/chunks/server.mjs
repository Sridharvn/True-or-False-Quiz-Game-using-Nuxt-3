import { version, getCurrentInstance, inject, ref, watchEffect, watch, useSSRContext, createApp, reactive, unref, provide, onErrorCaptured, onServerPrefetch, toRef, shallowRef, computed, isReadonly, defineAsyncComponent, isRef, mergeProps, withCtx, createVNode, nextTick, defineComponent, h, Suspense, Transition } from 'file://D:/Personal-Projects/True-False-Game/quiz-game/node_modules/vue/index.mjs';
import { $fetch } from 'file://D:/Personal-Projects/True-False-Game/quiz-game/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file://D:/Personal-Projects/True-False-Game/quiz-game/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://D:/Personal-Projects/True-False-Game/quiz-game/node_modules/unctx/dist/index.mjs';
import { renderSSRHead } from 'file://D:/Personal-Projects/True-False-Game/quiz-game/node_modules/@unhead/ssr/dist/index.mjs';
import { getActiveHead, createServerHead as createServerHead$1 } from 'file://D:/Personal-Projects/True-False-Game/quiz-game/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/Personal-Projects/True-False-Game/quiz-game/node_modules/@unhead/shared/dist/index.mjs';
import { createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from 'file://D:/Personal-Projects/True-False-Game/quiz-game/node_modules/vue-router/dist/vue-router.node.mjs';
import { sendRedirect, createError as createError$1, setResponseStatus as setResponseStatus$1 } from 'file://D:/Personal-Projects/True-False-Game/quiz-game/node_modules/h3/dist/index.mjs';
import { hasProtocol, parseURL, joinURL, isEqual } from 'file://D:/Personal-Projects/True-False-Game/quiz-game/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderAttrs } from 'file://D:/Personal-Projects/True-False-Game/quiz-game/node_modules/vue/server-renderer/index.mjs';
import { defu } from 'file://D:/Personal-Projects/True-False-Game/quiz-game/node_modules/defu/dist/defu.mjs';
...
const components = {};
const components_plugin_OMZJ83jSiV = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-slate-100 min-h-screen" }, _attrs))}>`);
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./error-component-55f0abd4.mjs').then((r) => r.default || r));

...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex justify-between items-center" }, _attrs))}><img${ssrRenderAttr("src", _imports_0)} alt="Logo" class="h-24 mix-blend-multiply"><ul class="flex justify-end mr-96"><li class="p-2">1</li><li class="p-2">2</li><li class="p-2">3</li><li class="p-2">4</li></ul></div>`);
}
...
//# sourceMappingURL=default-18a81976.mjs.map
